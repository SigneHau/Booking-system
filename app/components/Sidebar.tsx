    ...
    <aside className="bg-amber-50 flex flex-col items-center w-76 p-4">
      ...
      <nav className="flex-1 w-full">
        <ul className="space-y-3">
          {/* Book lokaler */}
          <li
            className={`flex items-center gap-3 p-2 rounded text-base font-normal ${openSans.className}`}
          >
            <FaHome />
          ...
          {/* Mine bookinger */}
          <li
            className={`flex items-center gap-3 p-2 rounded bg-primary  ${openSans.className}`}
          >
            <FaCalendarAlt />
            <span className="text-base font-normal">
          ...
          {/* Hjælp */}
          <li
            className={`flex items-center gap-3 p-2 rounded bg-primary hover:bg-hover text-secondary text-base font-normal ${openSans.className}`}
          >
            <FaExclamationCircle />
            <span className="text-base font-normal">
              <a href="/help">Hjælp</a>
      ...
      <div className="mt-6 flex flex-col items-center w-full">
        <div className="flex items-center gap-16 w-full p-3 rounded">
          ...
          <div className="flex flex-col">
            ...
            <p className={`text-sm opacity-90 ${openSans.className}`}>
              {user.role.charAt(0).toUpperCase() + user.role.slice(1)}
            </p>
            <p className={`text-sm opacity-70 mb-6 ${openSans.className}`}>
